...
type Link struct {
	...
	FromInstanceType int    `gorm:"column:from_instance_type;index:index_link_from_instance_type"`
	FromPlatformID   int    `gorm:"column:from_platform_id;index:index_link_from_platform_id"`
	To               string `gorm:"column:to;index:index_link_to"`
	ToInstanceType   int    `gorm:"column:to_instance_type;index:index_link_to_instance_type"`
	ToPlatformID     int    `gorm:"column:to_platform_id;index:index_link_to_platform_id"`
