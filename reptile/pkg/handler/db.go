...
func SetLastPostion(pos int64, identity string, platformID constants.PlatformID) error {
...
func GetLastPostion(identity string, platformID constants.PlatformID) int64 {
...
func GetResultFromDB(pos int64, endpos int64) ([]gitcoin.ProjectInfo, error) {
