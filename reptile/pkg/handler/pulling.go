...
func setProjectInfoInDB(currentPos int) (bool, error) {
	getProject := false
...
func printProjectInfoStage(currentPos int, getProject bool) {
	getProjectStr := "true"
...
func PullInformation(endpos int) {
...
func changeAddressFromDB(lastpos int, endPos int) error {
